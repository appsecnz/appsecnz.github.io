...
**Rohit Sharma** works at Medical IT Advisors as the Security Operations Manager. He's computer science graduate who finds cyber security to be the best fit for his energetic and curious personality. He has been managing IT cloud infrastructure and cyber security solutions across New Zealand healthcare and beyond for the past two years, with a focus on managing vulnerabilities, SIEM, WAFs and security controls across Microsoft 365, Azure and AWS clouds.
