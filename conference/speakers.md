...
The OWASP Benchmark Project is a Java test suite designed to evaluate the accuracy, coverage, and speed of automated software vulnerability detection tools. To enhance the picture the Benchmark provides, weâ€™ve used open source and commercial Static Application Security Testing (SAST) as well as Software Composition Analysis (SCA) tools to scan a number of our own applications.
...
**Karan Sharma** works as a pen tester for one of the leading telcos in New Zealand. He's been in the security industry for more than ten years. He has a true passion for breaking and fixing web and mobile apps. He enjoys doing web/mobile application security research in his free time and loves sharing his knowledge with others. If you want to shout things at him, heâ€™s @R00T on Twitter.
...
Sam's other areaâ€™s of interest include network penetration testing, 3D printing, and lock picking.
...
Kirk worked as a web developer before switching to the defence team - setting up Xeroâ€™s security practice, working as a pen tester, and in defence roles at several companies.
